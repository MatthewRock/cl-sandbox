...
SBCL_TARBALL_URL1="http://prdownloads.sourceforge.net/sbcl/sbcl-1.3.8-x86-64-linux-binary.tar.bz2"
SBCL_TARBALL_URL2="http://cddr.org/ci/sbcl-1.3.8-x86-64-linux-binary.tar.bz2"
